        ...
        Trace.encode = function encode(message, writer) {
            ...
            if (message.frames != null && message.frames.length)
                for (let i = 0; i < message.frames.length; ++i)
                    $root.motion.Frame.encode(message.frames[i], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            return writer;
        };
        ...
        Trace.fromObject = function fromObject(object) {
            ...
            if (object.frames) {
                if (!Array.isArray(object.frames))
                    throw TypeError(".motion.Trace.frames: array expected");
                message.frames = [];
    ...
    motion.Frame = (function() {
        ...
        Frame.encode = function encode(message, writer) {
            ...
            if (message.viewHierarchy != null && Object.hasOwnProperty.call(message, "viewHierarchy"))
                $root.motion.ViewNode.encode(message.viewHierarchy, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
