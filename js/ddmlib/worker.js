 ...
 */
const parseNode$1 = function(data) {
    const stack = [];
    let root = null;
    let lastNode = null;
...
self.onmessage = function(e) {
    ...
    const useOldParser = (cmd & CMD_PARSE_OLD_DATA) != 0;
    const rootNode = useOldParser
        ? parseNode$1(data)
        : parseNode(data, bitShift);
