...
export const motion = ($root.motion = (() => {
  ...
  motion.Trace = (function () {
     ...
     * @property {Array.<motion.IFrame>|null} [frames] Trace frames
     */
    ...
    /**
     * Trace frames.
     * @member {Array.<motion.IFrame>} frames
     * @memberof motion.Trace
     * @instance
     */
    Trace.prototype.frames = $util.emptyArray;
    ...
    Trace.encode = function encode(message, writer) {
      ...
      if (message.videoMetadata != null && Object.hasOwnProperty.call(message, 'videoMetadata'))
        $root.motion.VideoMetadata.encode(
          message.videoMetadata,
          writer.uint32(/* id 8, wireType 2 =*/ 66).fork()
        ).ldelim();
      if (message.frames != null && message.frames.length)
        for (let i = 0; i < message.frames.length; ++i)
          $root.motion.Frame.encode(
            message.frames[i],
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 9: {
            ...
            message.frames.push($root.motion.Frame.decode(reader, reader.uint32()));
            break;
          }
          default:
    ...
    Trace.verify = function verify(message) {
      ...
      if (message.captureTime != null && message.hasOwnProperty('captureTime')) {
        ...
        if (error) return 'captureTime.' + error;
      }
      if (message.processName != null && message.hasOwnProperty('processName'))
        if (!$util.isString(message.processName)) return 'processName: string expected';
      if (message.windowName != null && message.hasOwnProperty('windowName'))
        if (!$util.isString(message.windowName)) return 'windowName: string expected';
      ...
      if (message.videoMetadata != null && message.hasOwnProperty('videoMetadata')) {
        ...
        if (error) return 'videoMetadata.' + error;
      }
      if (message.frames != null && message.hasOwnProperty('frames')) {
        if (!Array.isArray(message.frames)) return 'frames: array expected';
        for (let i = 0; i < message.frames.length; ++i) {
          let error = $root.motion.Frame.verify(message.frames[i]);
    ...
    Trace.fromObject = function fromObject(object) {
      if (object instanceof $root.motion.Trace) return object;
      ...
      if (object.processName != null) message.processName = String(object.processName);
      if (object.windowName != null) message.windowName = String(object.windowName);
      ...
      if (object.frames) {
        if (!Array.isArray(object.frames)) throw TypeError('.motion.Trace.frames: array expected');
        message.frames = [];
        for (let i = 0; i < object.frames.length; ++i) {
          if (typeof object.frames[i] !== 'object')
            throw TypeError('.motion.Trace.frames: object expected');
          message.frames[i] = $root.motion.Frame.fromObject(object.frames[i]);
        }
      }
      return message;
    };
    ...
    Trace.toObject = function toObject(message, options) {
      ...
      if (message.frames && message.frames.length) {
        ...
        for (let j = 0; j < message.frames.length; ++j)
          object.frames[j] = $root.motion.Frame.toObject(message.frames[j], options);
      }
      return object;
    };
  ...
  motion.VideoMetadata = (function () {
    ...
    VideoMetadata.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.motion.VideoMetadata();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    VideoMetadata.verify = function verify(message) {
      ...
      if (message.widthPx != null && message.hasOwnProperty('widthPx'))
        if (!$util.isInteger(message.widthPx)) return 'widthPx: integer expected';
      if (message.heightPx != null && message.hasOwnProperty('heightPx'))
        if (!$util.isInteger(message.heightPx)) return 'heightPx: integer expected';
    ...
    VideoMetadata.fromObject = function fromObject(object) {
      if (object instanceof $root.motion.VideoMetadata) return object;
      let message = new $root.motion.VideoMetadata();
      if (object.widthPx != null) message.widthPx = object.widthPx | 0;
      if (object.heightPx != null) message.heightPx = object.heightPx | 0;
  ...
  motion.Frame = (function () {
     ...
     * @memberof motion
     * @interface IFrame
     * @property {number|null} [frameNumber] Frame frameNumber
    ...
    Frame.encode = function encode(message, writer) {
      ...
      if (message.frameNumber != null && Object.hasOwnProperty.call(message, 'frameNumber'))
        writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.frameNumber);
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, 'videoTimeSeconds')
      )
        writer.uint32(/* id 3, wireType 1 =*/ 25).double(message.videoTimeSeconds);
      if (message.viewHierarchy != null && Object.hasOwnProperty.call(message, 'viewHierarchy'))
        $root.motion.ViewNode.encode(
    ...
    Frame.verify = function verify(message) {
      ...
      if (message.frameNumber != null && message.hasOwnProperty('frameNumber'))
        if (!$util.isInteger(message.frameNumber)) return 'frameNumber: integer expected';
      if (message.frameNanos != null && message.hasOwnProperty('frameNanos'))
        if (
          !$util.isInteger(message.frameNanos) &&
          !(
            message.frameNanos &&
            $util.isInteger(message.frameNanos.low) &&
            $util.isInteger(message.frameNanos.high)
          )
        )
      ...
      if (message.viewHierarchy != null && message.hasOwnProperty('viewHierarchy')) {
        ...
        if (error) return 'viewHierarchy.' + error;
      }
      return null;
    };
    ...
    Frame.fromObject = function fromObject(object) {
      if (object instanceof $root.motion.Frame) return object;
      ...
      if (object.frameNanos != null)
        ...
        else if (typeof object.frameNanos === 'number') message.frameNanos = object.frameNanos;
        else if (typeof object.frameNanos === 'object')
          message.frameNanos = new $util.LongBits(
            object.frameNanos.low >>> 0,
            object.frameNanos.high >>> 0
          ).toNumber();
    ...
    Frame.toObject = function toObject(message, options) {
        ...
        if ($util.Long) {
          ...
          object.frameNanos =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.frameNanos = options.longs === String ? '0' : 0;
      ...
      if (message.frameNanos != null && message.hasOwnProperty('frameNanos'))
        if (typeof message.frameNanos === 'number')
          object.frameNanos =
            options.longs === String ? String(message.frameNanos) : message.frameNanos;
        else
          object.frameNanos =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.frameNanos)
              : options.longs === Number
              ? new $util.LongBits(
                  message.frameNanos.low >>> 0,
                  message.frameNanos.high >>> 0
                ).toNumber()
              : message.frameNanos;
      if (message.videoTimeSeconds != null && message.hasOwnProperty('videoTimeSeconds'))
        object.videoTimeSeconds =
          options.json && !isFinite(message.videoTimeSeconds)
            ? String(message.videoTimeSeconds)
            : message.videoTimeSeconds;
      if (message.viewHierarchy != null && message.hasOwnProperty('viewHierarchy'))
  ...
  motion.ViewNode = (function () {
    ...
    ViewNode.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.motion.ViewNode();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    ViewNode.verify = function verify(message) {
      ...
      if (message.translationX != null && message.hasOwnProperty('translationX'))
        if (typeof message.translationX !== 'number') return 'translationX: number expected';
      if (message.translationY != null && message.hasOwnProperty('translationY'))
        if (typeof message.translationY !== 'number') return 'translationY: number expected';
      ...
      if (message.willNotDraw != null && message.hasOwnProperty('willNotDraw'))
        if (typeof message.willNotDraw !== 'boolean') return 'willNotDraw: boolean expected';
      if (message.clipChildren != null && message.hasOwnProperty('clipChildren'))
        if (typeof message.clipChildren !== 'boolean') return 'clipChildren: boolean expected';
    ...
    ViewNode.fromObject = function fromObject(object) {
      if (object instanceof $root.motion.ViewNode) return object;
    ...
    ViewNode.toObject = function toObject(message, options) {
      ...
      if (message.id != null && message.hasOwnProperty('id')) object.id = message.id;
      if (message.left != null && message.hasOwnProperty('left')) object.left = message.left;
      ...
      if (message.scaleX != null && message.hasOwnProperty('scaleX'))
        object.scaleX =
          options.json && !isFinite(message.scaleX) ? String(message.scaleX) : message.scaleX;
      if (message.scaleY != null && message.hasOwnProperty('scaleY'))
        object.scaleY =
          options.json && !isFinite(message.scaleY) ? String(message.scaleY) : message.scaleY;
      if (message.alpha != null && message.hasOwnProperty('alpha'))
        object.alpha =
